...
export class CreateSubCategoryInput {
  @Field(() => String, {
    description: 'The name of the subcategory (e.g., "Shirts")',
  })
  ...
  @Matches(/^[a-zA-Z0-9\s-]+$/, {
    message:
      'Subcategory name can only contain letters, numbers, spaces, and hyphens',
  })
  name: string;
  ...
  @Field(() => String, {
    nullable: true,
    description: 'Optional HTTPS URL to an image',
  })
  @IsOptional()
  @IsUrl(
